...
import com.example.componentscan.scannedbeans.MainBean;
...
//exercise:
//move around DependencyBean to nonscanned package. Try to run application. Observe
//behaviour. Apply "fix" and re-run...

@SpringBootApplication
//before fix
@ComponentScan(basePackages = {"com.example.componentscan"})
//fix
//@ComponentScan(basePackages = {"com.example.componentscan","nonscanned"})
